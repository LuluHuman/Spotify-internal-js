import { AlbumSnippet } from "../Album/Album"
import { Artist, ArtistSnippet } from "./Artist";
import { Spotify } from "../../..";
import { AlbumArtistUnion, APIArtist } from "./Artist.types";
    ...
    return new Artist(spotify, {
        ...
        discography: {
            ...
            latest: apiAlbum.data.artistUnion.discography.latest ? new AlbumSnippet(spotify, {
                ...
                album_type: apiAlbum.data.artistUnion.discography.latest.type,
                artists: [artist],
                date: {
