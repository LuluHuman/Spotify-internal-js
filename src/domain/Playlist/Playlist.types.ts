...
import { APIChange, ColorPalette, ColorValue, datePrecision, ImageObject, Playability } from "../../infra/api_types"
...
interface APIPlaylistItem {
    ...
    "attributes": any[],
    "itemV2": APIPlaylistTrackResponseWrapper | APIEpisodeOrChapterResponseWrapper | APILocalTrackResponseWrapper,
...
export interface APILocalTrackResponseWrapper {
    "__typename": "EpisodeOrChapterResponseWrapper",
    "data": {
        "__typename": "LocalTrack",
        "albumName": string,
        "artistName": string,
        "localTrackDuration": { "totalMilliseconds": number },
        "name": string,
        "uri": string
    }
}
...
interface APIPlaylistEntityResponseWrapper {
    "__typename": "EntityResponseWrapper" | "LocalTrackResponseWrapper",
    "data"?: {
        "__typename": "Entity",
